...
namespace ppp
{
    namespace coroutines
    {
        ...
        public:
            ...
            bool                                                                R() noexcept { return ppp::threading::Executors::Dispatch(&context_, strand_, std::bind(&YieldContext::Resume, this)); }
            bool                                                                E() noexcept { return ppp::threading::Executors::Post(&context_, strand_, std::bind(&YieldContext::Resume, this)); }
